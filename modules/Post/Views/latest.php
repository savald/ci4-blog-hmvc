        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="about-right mb-90">
              <div class="about-img">
                <img src="<?= base_url(); ?>/blog/img/trending/trending_top.jpg" alt="">
              </div>
              ...
              <div class="social-share pt-30">
                <div class="section-tittle">
                  ...
                  <ul>
                    <li><a href="#"><img src="<?= base_url(); ?>/blog/img/news/icon-ins.png" alt=""></a></li>
                    <li><a href="#"><img src="<?= base_url(); ?>/blog/img/news/icon-fb.png" alt=""></a></li>
                    <li><a href="#"><img src="<?= base_url(); ?>/blog/img/news/icon-tw.png" alt=""></a></li>
                    <li><a href="#"><img src="<?= base_url(); ?>/blog/img/news/icon-yo.png" alt=""></a></li>
                  </ul>
                </div>
              </div>
            </div>
